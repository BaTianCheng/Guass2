...
public class CsvWriter {
	...
	/**
	 * Creates a {@link com.cw.guass2.common.util.helper.csvreader.CsvWriter CsvWriter} object using a file
	...
	/**
	 * Creates a {@link com.cw.guass2.common.util.helper.csvreader.CsvWriter CsvWriter} object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	...
	/**
	 * Creates a {@link com.cw.guass2.common.util.helper.csvreader.CsvWriter CsvWriter} object using an
	...
	public void write(String content, boolean preserveSpaces) throws IOException {
		...
		if(!textQualify && userSettings.UseTextQualifier
				&& (content.indexOf(userSettings.TextQualifier) > -1 || content.indexOf(userSettings.Delimiter) > -1
						...
						|| (useCustomRecordDelimiter && content.indexOf(userSettings.RecordDelimiter) > -1) || (firstColumn && content.length() > 0 && content.charAt(0) == userSettings.Comment) ||
